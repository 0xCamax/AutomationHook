...
interface IV3PoolImmutables {
    ...
    function positions(bytes32 poolKey) external view returns (uint128 liquidity, uint256 feeGrowthInside0LastX128, uint256 feeGrowthInside1LastX128, uint128 tokensOwed0, uint128 tokensOwed1);
